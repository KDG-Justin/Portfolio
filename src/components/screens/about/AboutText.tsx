...
export function AboutTextSection(){
    return(
        <div>
            ...
            het maakt geen verschil. Bouwen en mensen helpen is iets wat er bij mij al van jongs af aan in zat. Met die passie ben ik vervolgens gaan lopen...
            
            Ik kom letterlijk en figuurlijk van ver. 
            Letterlijk: Ik ben geboren in Suriname maar ik heb de nationaliteit van een Belg.
            Figuurlijk: Ik heb bedrijfslogistiek gestudeerd voordat ik aan mijn IT-bachelor ben begonnen. Twee verschillende werelden
            maar nog altijd is het me gelukt om mijn bachelor te halen zonder enige voorkennis. 
            ...
            De tweede is dan mijn proffesionele character. Hier ben ik geordend, puntjes op de i, een planner en iemand die zijn
            werk heel serieus neemt. 
